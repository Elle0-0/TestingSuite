...
def main():
    ...
    try:
        ...
        # For demonstration purposes, show sample output if endpoints are unreachable
        print(f"Note: Could not reach example endpoints ({e}).")
        print("Demonstrating with sample data instead:\n")
        ...
        print(f"\nSample raw JSON output:")
        print(json.dumps(sample_readings, indent=2))
